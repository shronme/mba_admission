"""
Evaluator for IntakeInterviewer.

Usage
-----
from evals.evaluators.intake_interviewer import run_eval, compare_signatures, optimize
from evals.datasets import intake_interviewer as ds
from app.dspy.intake_interviewer import OpenAIIntakeInterviewer

devset = ds.load()
score = run_eval(OpenAIIntakeInterviewer(), devset)
results = compare_signatures(devset)
compiled = optimize(OpenAIIntakeInterviewer(), trainset=devset[:6], devset=devset[6:])
"""
...
from evals.datasets import intake_interviewer as _ds
...
from evals.metrics import intake_composite_metric
from evals.signatures.intake_interviewer import DEFAULT, REGISTRY

METRIC: Callable = intake_composite_metric
...
def compare_signatures(
    ...
    *,
    ...
    print_comparison_table("intake_interviewer", len(devset), results)
    return results
