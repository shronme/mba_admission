"""
Evaluator for DocumentClassifier.

Usage
-----
from evals.evaluators.document_classifier import run_eval, compare_signatures, optimize
from evals.datasets import document_classifier as ds
from app.dspy.document_classifier import OpenAIDocumentClassifier

devset = ds.load()
score = run_eval(OpenAIDocumentClassifier(), devset)
results = compare_signatures(devset)
compiled = optimize(OpenAIDocumentClassifier(), trainset=devset[:12], devset=devset[12:])
"""
...
from evals.datasets import document_classifier as _ds
...
from evals.metrics import document_classifier_metric
from evals.signatures.document_classifier import DEFAULT, REGISTRY

METRIC: Callable = document_classifier_metric
...
def compare_signatures(
    ...
    *,
    ...
    print_comparison_table("document_classifier", len(devset), results)
    return results
